...
class TestMusicaView(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.musica1 = Musica.objects.create(
        ...
        cls.musica2 = Musica.objects.create(
    ...
    def test_PATCH_success(self):
        ...
        self.client.login(username="testuser1", password="1X<ISRUkw+tuK")
        actualizacion = reverse("musica:detail", kwargs={"pk": self.musica1.id})
        data_info = {"cancion": "cancion que deberia estar incluida en mi lista"}
